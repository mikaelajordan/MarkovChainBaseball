...
mod = SourceModule("""
    #include <stdio.h>
    __global__ void simulate_game(ushort *scores, char *rbi, float *T, char *outs, char *lineup, float *rand, uint *rand_start, uint num_rands, char print_level)
    {
...
""")
func = mod.get_function("simulate_game")
